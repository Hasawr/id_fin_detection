...
class FieldSlice:
    ...
    line: int = 1  # 1-based MRZ line number
...
TD2_LINE_LENGTH = 36
TD2_SERIAL = FieldSlice(0, 9, line=2)
TD2_SERIAL_CHECK = FieldSlice(9, 10, line=2)
TD2_NATIONALITY = FieldSlice(10, 13, line=2)
TD2_FIN = FieldSlice(28, 35, line=2)
TD2_COMPOSITE_CHECK = FieldSlice(35, 36, line=2)
...
TD1_LINE_LENGTH = 30
TD1_ISSUING_STATE = FieldSlice(2, 5, line=1)
TD1_SERIAL = FieldSlice(5, 14, line=1)
TD1_SERIAL_CHECK = FieldSlice(14, 15, line=1)
TD1_FIN = FieldSlice(15, 22, line=1)
TD1_OPTIONAL_END = 29
