...
def draw_mrz_debug(img: np.ndarray, line1: str, line2: str, line3: str, fin_text: str) -> np.ndarray:
    """
    Overlay reconstructed MRZ lines and the extracted FIN on the image.
    """
    debug_img = img.copy()
    ...
    cv2.putText(debug_img, f"L1: {line1}", (10, h - 80), font, 0.5, (255, 255, 255), 1)
    cv2.putText(debug_img, f"L2: {line2}", (10, h - 60), font, 0.5, (255, 255, 255), 1)
    cv2.putText(debug_img, f"L3: {line3}", (10, h - 40), font, 0.5, (255, 255, 255), 1)
    cv2.putText(debug_img, f"Extracted FIN: {fin_text}", (10, h - 15), font, 0.6, (0, 255, 0), 2)
